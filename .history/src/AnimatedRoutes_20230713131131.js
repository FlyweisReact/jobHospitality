    ...
    <>
      <AnimatePresence>
        <Routes location={location} key={location.pathname}>
          ...
          <Route path="/courses" element={  <Wrapper childer={<Courses />} />} <Courses />} />
          <Route path="/community" element={  <Wrapper childer={<Community />} />} <Community />} />
          <Route path="/staff-logIn" element={  <Wrapper childer={<StaffLoginIn />} />} <StaffLoginIn />} />
          <Route path="/book-an-event" element={  <Wrapper childer={<BookAnEvent />} />} <BookAnEvent />} />
          <Route path="/book-full-bar" element={  <Wrapper childer={<BookFullService />} />} <BookFullService />} />
          <Route path="/permanent-job" element={ <Wrapper childer={<PermanentJob />} />}v <PermanentJob />} />
          <Route path="/casual-staff" element={  <Wrapper childer={<CasualStaff />} />} <CasualStaff />} />
          <Route path="/permanent-staff" element={  <Wrapper childer={<PermanentStaff />} />} <PermanentStaff />} />
          <Route path="/client-login" element={ <Wrapper childer={<ClientLoginIn />} />} <ClientLoginIn />} />
        </Routes>
      </AnimatePresence>
    </>
  );
