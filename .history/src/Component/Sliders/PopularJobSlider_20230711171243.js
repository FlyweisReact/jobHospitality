...
import { BartenderModal } from "../Modals/BartenderModal";
...
const PopularJobSlider = () => {
  ...
  return (
    <>
      <BartenderModal show={modalShow} onHide={() => setModalShow(false)} />
        ...
        <Slider {...settings} ref={sliderRef} className="Service_Slider">
          <div className="Main hover"  >
            ...
            <div className="content-div">
              ...
              <button onClick={() => setModalShow(true)}>FIND OUT MORE </button>
            </div>
          </div>
